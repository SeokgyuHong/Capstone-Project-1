...
public class GetPushTokenResponse {
    public static final ResponseStringConverter<PushTokenInfo> CONVERTER = new ResponseStringConverter<PushTokenInfo>() {
        @Override
        public PushTokenInfo convert(String o) throws ResponseBody.ResponseBodyException {
